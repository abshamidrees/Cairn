...
**An observation is one event Firsthand watched happen and hashed.** Not a rating somebody left, but an
...
registries, so those are what exist. Firsthand shows three kinds and says three.
