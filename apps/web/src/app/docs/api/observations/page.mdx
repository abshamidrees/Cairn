...
- `GET /v1/stats` returns what Firsthand currently holds across the whole indexed set.
- `GET /v1/recent` returns the last few counterparties looked up, read from Firsthand's own dossier
